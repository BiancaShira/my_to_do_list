...
app.config['SQLALCHEMY_DATABASE_URI']='mysql://root:Pa@ssw0rd@localhost:3306/mydatabase'   + os.path.join(basedir , 'database.db')
...
@app.route("/list/")
def index ():
              return render_template("to_do_list.html", to_dos=to_dos)